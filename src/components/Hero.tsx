...
const Hero = () => {
  return (
    <div
  id="hero"
  className=" min-h-screen bg-no-repeat bg-[url(/banner_bg2.jpg)] bg-cover rounded"
  style={{ backgroundSize: "35%", backgroundPosition: "left 100px top 100px", borderRadius:"50px"}} 
>
